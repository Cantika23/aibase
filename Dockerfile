...
RUN apt-get update && \
    apt-get install -y curl lsof pandoc sqlite3 unzip && \
    curl -L https://github.com/duckdb/duckdb/releases/download/v1.4.4/duckdb_cli-linux-amd64.zip -o /tmp/duckdb.zip && \
