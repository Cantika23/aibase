...
async function extractTextFromPowerPoint(filePath: string): Promise<string> {
  ...
  return documentExtractorModule.extractTextFromPowerPoint(filePath);
}
